...
class ForwardCompositionalSE3 : public NLLSSolver<6, Sophus::SE3d> {
...
protected:
  ...
  virtual double
  computeResiduals (const Sophus::SE3d& model, bool linearize_system, bool compute_weight_scale = false);
...
class SecondOrderMinimisationSE3 : public NLLSSolver<6, Sophus::SE3d> {
