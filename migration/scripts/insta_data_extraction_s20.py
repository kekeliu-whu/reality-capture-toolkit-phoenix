...
# extraction dir and REPO_ROOT is wrong.  Use sys.executable's parent instead,
# because the exe lives in build-pack/ next to the MediaSDK/ folder.
if getattr(sys, "frozen", False):
    DEFAULT_MEDIASDK_EXE = (
        Path(sys.executable).parent / "MediaSDK" / "MediaSDKTest.exe"
    )
else:
...
parser.add_argument(
    ...
    type=str,
    default=R"Z:\rick\dataset\lianhuacheng-s20\2026-04-20_11-31-03_PointCloud\VID_20260420_113102_00_026.insv",
...
parser.add_argument(
    "--output-dir",
    type=str,
    default=R"Z:\rick\dataset\lianhuacheng-s20\2026-04-20_11-31-03_PointCloud\output\images",
